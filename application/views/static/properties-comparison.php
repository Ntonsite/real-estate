...
<!-- Comparison start -->
<div class="comparison faq content-area-6">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="comparison-search">
                    <form method="GET">
                        <h3>Select Propertie's You Want To Compare</h3>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="form-group">
                                    <select class="selectpicker search-fields" name="balcony">
                                        ...
                                        <option>Beautiful Single Home</option>
                                        <option>Sweet Family Home</option>
                                        <option>Park Avenue</option>
                                        <option>Masons Villas</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="form-group">
                                    <select class="selectpicker search-fields" name="balcony">
                                        <option>Relaxing Apartment</option>
                                        <option>Luxury</option>
                                        <option>Beautiful Single Home</option>
                                        <option>Sweet Family Home</option>
                                        <option>Park Avenue</option>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="thumbnail compare-properties clearfix">
                            <div class="compare-photo">
                                <img src="http://placehold.it/515x343" alt="properties-1" class="img-responsive">
                                <div class="price-ratings-box">
                                    <h5 class="price">$178,000</h5>
                                    <div class="rating">
                            ...
                            <div class="caption detail">
                                <h3><a href="properties-details.html">Beautiful Single Home</a></h3>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown</p>
                                <a href="properties-details.html" class="read-more">Read More...</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="thumbnail compare-properties clearfix">
                            <div class="compare-photo">
                                <img src="http://placehold.it/515x343" alt="properties-2" class="img-responsive">
                                <div class="price-ratings-box">
                                    <h5 class="price">$358,000</h5>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                            ...
                            <!-- Detail -->
                            <div class="caption detail">
                                <h3><a href="properties-details.html">Modern Family Home</a></h3>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown</p>
                                <a href="properties-details.html" class="read-more">Read More...</a>
                            </div>
                        </div>
                                                ...
                                                <div class="panel-heading active" role="tab" id="heading1">
                                                    <h4 class="panel-title">
                                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="false">
                                                            <i class="fa fa-plus"></i>What do you mean by an End Product?
                                                        </a>
                                                    </h4>
                                                </div>
                                                <div id="collapse1" class="panel-collapse collapse" role="tabpanel" aria-expanded="false">
                                                    <div class="panel-body compare-table">
                                                        <table>
                                                            <tbody>
                                                            <tr>
                                                                <td> Engine Type </td>
                                                ...
                                                <div class="panel-heading" role="tab" id="heading2">
                                                    <h4 class="panel-title">
                                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="false">
                                                            <i class="fa fa-plus"></i>Where do I find my Purchase or License code?
                                                        </a>
                                                    </h4>
                                                </div>
                                                ...
                                                <div class="panel-heading" role="tab" id="heading3">
                                                    <h4 class="panel-title">
                                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-expanded="false">
                                                            <i class="fa fa-plus"></i>Do I need to buy a licence for each site?
                                                        </a>
                                                    </h4>
                                                </div>
                                                ...
                                                <div class="panel-heading" role="tab" id="heading4">
                                                    <h4 class="panel-title">
                                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse4" aria-expanded="false">
                                                            <i class="fa fa-plus"></i>Is my license transferable?
                                                        </a>
                                                    </h4>
                                                </div>
