        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="about-text">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempor arcu non ligula convallis, vel tincidunt ipsum posuere. Fusce sodales lacus ut pellentes sollicitudin. Duis iaculis, arcu ut hendrerit pharetra, elit augue pulvinar magna, a consectetur eros quam  magna, a consectetur eros</p>
...
<!-- Customer say start -->
<div class="content-area customer-say chevron-icon">
    <div class="container">
        <!-- Main title -->
        <div class="main-title">
