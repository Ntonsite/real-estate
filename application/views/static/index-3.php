                    ...
                    <div class="container">
                        <div class="carousel-caption banner-slider-inner">
                            <!--<div class="banner-content">
                                <h1 data-animation="animated fadeInUp delay-05s"><span>Welcome to</span> The Nest</h1>
                                <a href="#" class="btn button-md button-theme" data-animation="animated fadeInUp delay-05s">Learn More</a>
                            </div>-->
                        </div>
                    </div>
                </div>
...
<div class="content-area  recently-properties chevron-icon">
    <div class="container">
        <!-- Main title -->
        <div class="main-title">
...
<!-- Customer say start -->
<div class="mb-70 customer-say chevron-icon">
    <div class="container">
        <!-- Main title -->
        <div class="main-title">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="customers-say-box">
                                ...
                                <div class="header clearfix">
                                    <h2>John Antony</h2>
                                    <h4>Bangladesh</h4>
                                    <img src="http://placehold.it/95x95" alt="avatar-1" class="profile-img">
                                </div>
                                <!-- Detail -->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="customers-say-box">
                                ...
                                <div class="header clearfix">
                                    <h2>Karen Paran</h2>
                                    <h4>Bangladesh</h4>
                                    <img src="http://placehold.it/95x95" alt="avatar-2" class="profile-img">
                                </div>
                                <!-- Detail -->
                                <div class="detail clearfix">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et</P>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="customers-say-box">
                                ...
                                <div class="header clearfix">
                                    <h2>David Jackson</h2>
                                    <h4>Bangladesh</h4>
                                    <img src="http://placehold.it/95x95" alt="avatar-3" class="profile-img">
                                </div>
                                <!-- Detail -->
                                <div class="detail clearfix">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et</P>
                    ...
                    <div class="item">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="customers-say-box">
                                <!--header -->
                                <div class="header clearfix">
                                    <h2>Eliane Pereira</h2>
                                    <h4>Bangladesh</h4>
                                    <img src="http://placehold.it/95x95" alt="avatar-4" class="profile-img">
                                </div>
                                <!-- Detail -->
                                <div class="detail clearfix">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et</P>
