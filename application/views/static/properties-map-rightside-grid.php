    ...
    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-6 map-content-sidebar">
        ...
        <div class="title-area">
            ...
            <div class="pull-right btns-area">
                <a href="properties-map-rightside-list.html" class="change-view-btn"><i class="fa fa-th-list"></i></a>
                <a href="properties-map-rightside-grid.html" class="change-view-btn active-view-btn"><i class="fa fa-th-large"></i></a>
            </div>
            <div class="clearfix"></div>
        </div>
