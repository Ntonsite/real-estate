...
<div class="properties-gallery pg content-area-7">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="filtr-container">
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 pad  filtr-item" data-category="1, 2, 3">
                    <div class="portfolio-item car-magnify-gallery">
                        <a href="http://placehold.it/750x540" title="Park Avenue">
                            <img src="http://placehold.it/224x150" alt="properties-gallery" class="img-fluid">
                        </a>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 pad  filtr-item" data-category="1">
                    <div class="portfolio-item car-magnify-gallery">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 pad  filtr-item" data-category="2, 3">
                    <div class="portfolio-item car-magnify-gallery">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 pad  filtr-item" data-category="3, 4">
                    <div class="portfolio-item car-magnify-gallery">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 pad  filtr-item" data-category="4">
                    <div class="portfolio-item car-magnify-gallery">
