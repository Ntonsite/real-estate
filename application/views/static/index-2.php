...
<div class="section-4">
    <div class="container wow fadeInUp delay-03s">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="service-item hidden-mb-0">
                    <div class="icon">
                        <i class="flaticon-technology-1"></i>
                    </div>
                    <div class="detail">
                        <h3>Home Designs Ideas</h3>
                        <p>Our specialists can help you get started on that home project. Find paint, that perfect tile and more.</p>
                        <a href="blog-single-sidebar-right.html" class="read-more">Read More...</a>
                    </div>
                </div>
            </div>
...
<div class="content-area-4 featured-properties">
    <div class="container">
        <!-- Main title -->
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 wow fadeInLeft delay-04s">
                ...
                <div class="agent-2 clearfix">
                    <div class="col-lg-5 col-md-5 col-sm-12 agent-theme-2">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 agent-content">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 wow fadeInRight delay-04s">
                ...
                <div class="agent-2 clearfix">
                    <div class="col-lg-5 col-md-5 col-sm-12 agent-theme-2">
                        <img src="http://placehold.it/231x231" alt="team-3" class="img-responsive">
                        <!-- social list -->
                        <ul class="social-list clearfix">
                            <li>
                                <a href="#" class="facebook">
                ...
                <div class="text-center">
                    <div id="carouse3-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item content active clearfix">
                                <div class="item-inner">
                                    <div class="text">
                                        ...
                                        Lorem ipsum dolor sit amet, nemore facete quo cu, sumo tincidunt pri ex, usu ubique percipitur ea. Ut fugit quaestio Lorem ipsum dolor sit amet, nemore facete quo cu, sumo tincidunt pri ex, usu ubique percipitur ea. Ut fugit quaestio
                                        <sub>
                                            <i class="fa fa-quote-right"></i>
                                        </sub>
                                    </div>
                                    <div class="avatar">
                                        <img src="http://placehold.it/120x120" alt="avatar-2">
                                    </div>
                                    <h4>Karen Paran</h4>
                                </div>
                            </div>
                            <div class="item content clearfix">
                                <div class="item-inner">
                                    ...
                                    <div class="avatar">
                                        <img src="http://placehold.it/120x120" alt="avatar-3">
                                    </div>
                                    <h4>David Jackson</h4>
                                </div>
                            </div>
                            <div class="item content clearfix">
                                <div class="item-inner">
                                    ...
                                    <div class="avatar">
                                        <img src="http://placehold.it/120x120" alt="avatar-4">
                                    </div>
                                    <h4>John Antony</h4>
                                </div>
                            </div>
                        ...
                        <a class="left carousel-control" href="#carouse3-example-generic" role="button" data-slide="prev">
                            <span class="slider-mover-left t-slider-r" aria-hidden="true">
                                <i class="fa fa-angle-left"></i>
                            </span>
                            <span class="sr-only">Previous</span>
                        </a>
                        <a class="right carousel-control" href="#carouse3-example-generic" role="button" data-slide="next">
                            <span class="slider-mover-right t-slider-l" aria-hidden="true">
