...
<!-- Elements page start -->
<div class="content-area-6 elements-page">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="alert-section mb-50">
                ...
                <div class="panel-section mb-50">
                    <h3 class="heading-2">Panel</h3>
                    <div class="panel panel-primary mb-0">
                        <div class="panel-heading"><h3 class="panel-title">Panel title</h3></div>
                        <div class="panel-body"> Nulla porttitor accumsan tincidunt. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula. Curabitur aliquet quam id dui posuere blandit. Donec rutrum congue leo eget malesuada. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Curabitur aliquet quam id dui posuere blandit. Nulla quis lorem ut libero malesuada feugiat. Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Nulla porttitor accumsan tincidunt. Nulla quis lorem ut libero malesuada feugiat.t</div>
                    </div>
                </div>
                <div class="tables mb-50">
                    <h3 class="heading-3">Tables</h3>
                ...
                <div class="active-items mb-50">
                    <h3 class="heading-2">Active items</h3>
                    <ul class="list-group mb-0">
                        <li class="list-group-item bg-active">Cras justo odio</li>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="notice-section mb-50">
                    <h3 class="heading-3">Notice</h3>
                ...
                <div class="progress-section mb-50">
                    <h3 class="heading-3">Progress</h3>
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 17%" aria-valuenow="17" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: 34%" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: 51%" aria-valuenow="51" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped bg-warning" role="progressbar" style="width: 68%" aria-valuenow="68" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress">
                ...
                <div class="button-section mb-50">
                    ...
                    <p>
                        <a href="#" class="btn button-lg border-button-theme">Details</a>
                        <a href="#" class="btn button-md border-button-theme">Details</a>
                        <a href="#" class="btn button-sm border-button-theme">Details</a>
                    </p>
                    <p>
                        <a href="#" class="btn button-lg button-theme">Details</a>
                        <a href="#" class="btn button-md button-theme">Details</a>
