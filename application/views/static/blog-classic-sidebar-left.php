    ...
    <div class="container">
        <div class="breadcrumb-area">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="active">Blog Classic Left Sidebar</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-xs-12 col-md-push-4">
                ...
                <div class="thumbnail blog-box clearfix">
                    <img src="http://placehold.it/750x416" alt="blog-3">
                    <!-- Detail -->
                        ...
                        <div id="carousel-custom" class="carousel slide" data-ride="carousel">
                            <div class="carousel-outer">
                                ...
                                <div class="carousel-inner">
                                    <div class="item">
                                        <img src="http://placehold.it/750x416" class="img-preview img-responsive" alt="blog-3">
                                    </div>
                                    <div class="item active left">
                                        <img src="http://placehold.it/750x416" class="img-preview img-responsive" alt="blog-3">
                                    </div>
                                    <div class="item next left">
                                        <img src="http://placehold.it/750x416" class="img-preview img-responsive" alt="blog-1">
                                    </div>
                                </div>
                                <!-- Controls -->
                ...
                <div class="thumbnail blog-box clearfix">
                    <img src="http://placehold.it/750x416" alt="blog-2">
                    <!-- Detail -->
                    <div class="caption detail">
                        <div class="date-box">
                            <h5>03</h5>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li class="active"><a href="blog-classic-sidebar-left.html">2</a></li>
