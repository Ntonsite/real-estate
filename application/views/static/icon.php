...
<!-- Icon Lists start -->
<div class="icon-lists content-area">
    <div class="container">
        <div class="row mb-40">
            <div class="col-lg-12">
                <h1 class="heading">Flaticon</h1>
                <mark>Usage: &nbsp; &lt;i class="flaticon-air-conditioner"&gt;&lt;/i&gt;</mark>
                <div>
                    ...
                    <div class="glyph"><div class="glyph-icon flaticon-for-sale"></div>
                    ...
                    <div class="glyph"><div class="glyph-icon flaticon-person-enjoying-jacuzzi-hot-water-bath"></div>
                        <div class="class-name">.flaticon-person-enjoying-jacuzzi-hot-water-bath</div>
                    </div>
                    ...
                    <div class="glyph"><div class="glyph-icon flaticon-sign-out-option"></div>
        ...
        <div class="row mb-40">
            <div class="col-lg-12">
                <h1 class="heading">Linearicons</h1>
        ...
        <div class="row mb-40">
            <div class="col-lg-12">
                <h1 class="heading">Glyphicons</h1>
                <mark>Usage: &nbsp; &lt;i class="glyphicon glyphicon-asterisk"&gt;&lt;/i&gt;</mark>
        ...
        <div class="row mb-40">
            <div class="col-lg-12">
                <h1 class="heading">Font Awesome</h1>
            ...
            <div class="col-lg-12 font-awesome-icons">
                ...
                <div class="col-md-4 col-sm-6 col-lg-3 col-print-4">
                    <small class="text-muted pull-right">4.3</small>
                    <i class="fa fa-fw" aria-hidden="true" title="Copy to use rss-p"></i>
                    fa-rss-p
