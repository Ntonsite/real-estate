...
<!-- Faq body start -->
<div class="faq-body content-area-6">
    <div class="container">
        <!-- Main title -->
            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2">
                ...
                <div class="panel-box">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#extraFeatures" data-toggle="tab" aria-expanded="false">Extra feature</a></li>
                        <li class=""><a href="#VehicleOverview" data-toggle="tab" aria-expanded="false">Properties Overview</a></li>
                    </ul>
