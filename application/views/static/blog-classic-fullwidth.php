    ...
    <div class="container">
        <div class="breadcrumb-area">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="active">Blog Classic FullWidth</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="thumbnail blog-box clearfix">
                    <img src="http://placehold.it/1140x500" alt="blog-04" class="img-responsive">
                    <!-- Detail -->
                    <div class="caption detail">
                        ...
                        <!-- paragraph -->
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.But also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.But also the leap into electronic typesetting, Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.But also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with</p>
                        ...
                        <div id="carousel-custom" class="carousel slide" data-ride="carousel">
                            <div class="carousel-outer">
                                ...
                                <div class="carousel-inner">
                                    <div class="item">
                                        <img src="http://placehold.it/1140x500" class="img-preview img-responsive" alt="blog-4">
                                    </div>
                                    <div class="item">
                                        <img src="http://placehold.it/1140x500" class="img-preview img-responsive" alt="blog-5">
                                    </div>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <li><a href="blog-classic-sidebar-right.html">1 <span class="sr-only">(current)</span></a></li>
                        <li><a href="blog-classic-sidebar-left.html">2</a></li>
                        <li class="active"><a href="blog-classic-fullwidth.html">3</a></li>
                        <li>
