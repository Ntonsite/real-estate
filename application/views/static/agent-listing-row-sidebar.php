    ...
    <div class="overlay">
        <div class="container">
            <div class="breadcrumb-area">
                <h1>Agent List Sidebar</h1>
                <ul class="breadcrumbs">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Agent List Sidebar</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-7 col-sm-7 col-xs-10 cod-pad">
                    <div class="sorting-options">
                        ...
                        <a href="agent-listing-row-sidebar.html" class="change-view-btn active-view-btn"><i class="fa fa-th-list"></i></a>
                        <a href="agent-listing-grid-sidebar.html" class="change-view-btn"><i class="fa fa-th-large"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <!-- Agent box 2 start -->
                <div class="agent-2 a-2 clearfix">
                    <div class="col-lg-4 col-md-4 col-sm-4 agent-theme-2">
                ...
                <div class="agent-2 a-2 clearfix">
                    <div class="col-lg-4 col-md-4 col-sm-4 agent-theme-2">
                        <img src="http://placehold.it/231x231" alt="team-4" class="img-responsive">
                        <!-- social list -->
                        <ul class="social-list clearfix">
                            <li>
                                <a href="#" class="facebook">
                ...
                <div class="agent-2 a-2 clearfix">
                    <div class="col-lg-4 col-md-4 col-sm-4 agent-theme-2">
                        <img src="http://placehold.it/231x231" alt="team-1" class="img-responsive">
                        <!-- social list -->
                        <ul class="social-list clearfix">
                            <li>
                                <a href="#" class="facebook">
